                ...
                <div class="collapse navbar-collapse navbar-right" id="bs-example-navbar-collapse-1">
                    <nav class="menu menu--iris">
                        <ul class="nav navbar-nav menu__list">
                            <li class="menu__item"><a href="http://localhost/tugas_hotel" class="menu__link">Home</a></li>
                            <li class="menu__item menu__item--current"><a href="javascript:" class="menu__link">Profile</a></li>
                            <li class="dropdown menu__item">
                                                ...
                                                <?php
                                                    if(isset($_POST["login"])){
                                                        ...
                                                        if(mysqli_num_rows($query_cari) == 1){
                                                            ...
                                                            $pesan = "You've successfully logged in.";
                                ...
                                ?>
                                <a href="#" class="menu__link scroll dropdown-toggle" data-toggle="dropdown">
                                    <i class="fa fa-user"></i> Welcome, <?php echo $_SESSION["fname"]; ?></b>
                                    <span class="caret"></span>
                                </a>
                                <ul id="login-dp" class="dropdown-menu">
                                    <li>
                                        <div class="row">
                                            <div class="col-md-12">
                                                <ul class="nav navbar-nav side-nav">
                                                    ...
                                                    <li>
                                                        <br>
                                                        <a href="<?php echo 'profile?id='.$_SESSION['user_id']; ?>">
