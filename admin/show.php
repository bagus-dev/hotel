...
<head>
    <meta charset="UTF-8">
    <title>Details of Booking Room - Admin Area</title>
    <style>
        /* reset */
...
<body>
    ...
    <header>
        ...
        <address>
            <p>REGAL RAYA HOTEL</p>
            <p>Anyer,<br>Kota Cilegon, Banten,<br>Indonesia.</p>
            <p>(0254) 222 44 55</p>
        </address>
    </header>
    <article>
        ...
        <table class="meta">
            <tr>
                <th><span>No. Booking</span></th>
                <th><span><?php echo $no_trx; ?></span></th>
            </tr>
            <tr>
                <th><span>Customer ID</span></th>
                <th><span><?php echo $cus_id; ?></span></th>
            </tr>
            <tr>
                <th><span>Check-In Date</span></th>
                <th><span><?php echo $cin; ?></span></th>
            </tr>
            <tr>
                <th><span>Check-Out Date</span></th>
                <th><span><?php echo $cout; ?></span></th>
            </tr>
        </table>
        <table>
            <tr>
    ...
    <aside>
        ...
        <div>
            <p align="center">Email :- info@REGAL RAYA.com || Web :- www.REGAL RAYA.com || Phone :- 0254 222 44 55</p>
        </div>
    </aside>
</body>
</html>
